  ...
  updateNavbarHeight = () => {
    if (document.getElementById("header_navbar")) {
      this.navbar_height = parseInt(
        getComputedStyle(
          document.getElementById("header_navbar"),
      ...
      <div className="header__container">
        ...
        >
          <h3 className="header__link-home" id="header_link-home">
            <NavLink
              scroll={(el) => this.scrollWithOffset(el, this.navbar_height)}
              to="/home#objective"
            >
              Home
            </NavLink>
          ...
          <h3 className="header__link-timeline" id="header_link-qualifications">
            <NavLink
              scroll={(el) => this.scrollWithOffset(el, this.navbar_height)}
              to="/timeline#qualifications-title"
            >
              Qualifications
            </NavLink>
          </h3>
